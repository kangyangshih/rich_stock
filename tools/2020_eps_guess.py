...
for stockID, stock in allStock.items():
    ...
    value = float (AllStockMgr.getInfo (stockID, "股本"))
    writeMsg ("股本 : %.2f 億", value)
    writeMsg ("每股淨值 : %s 元", AllStockMgr.getInfo (stockID, "淨值"))
    writeMsg ("=== 2019 EPS ===")
    writeMsg ("2019 EPS : %s 元", AllStockMgr.getInfo (stockID, "QEPS", "2019"))
    # 2020Q1
    writeMsg ("=== 2020 EPS ===")
    TurnOver_2020Q1 = AllStockMgr.getInfoInt (stockID, "營收", "2020/01", "月營收") + \
                      AllStockMgr.getInfoInt (stockID, "營收", "2020/02", "月營收") + \
    ...
    writeMsg ("2020Q1 營收 : %3.2f億, EPS : %2.2f 元, 淨利 : %2.2f", TurnOver_2020Q1, AllStockMgr.getInfoFloat (stockID, "QEPS", "2020Q1"), earnRate)
    # 2020Q2
    TurnOver_2020Q2 = AllStockMgr.getInfoInt (stockID, "營收", "2020/04", "月營收") + \
