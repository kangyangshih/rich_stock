...
for stockID, stock in allStock.items():
    ...
    writeMsg ("=== 2019 EPS ===")
    writeMsg ("2019 EPS : %s 元", stock.getInfo ("QEPS", "2019", "EPS"))
    # 2020Q1
    writeMsg ("=== 2020 EPS ===")
    if stock.getInfoInt ("月營收", "2020/01", "月營收") == None:
        continue
    ...
    info["TurnOver_2020Q1"] = "%.2f" % (TurnOver_2020Q1,)
    #print (TurnOver_2020Q1)
    if TurnOver_2020Q1 == 0:
        continue
    #  毛利的取得
    #earnRate = stock.getInfoFloat ("QEPS", "2020Q1", "稅後淨利率")
    #if earnRate == None:
    #    continue
    #writeMsg ("2020Q1 營收 : %3.2f億, EPS : %2.2f 元, 淨利 : %2.2f", TurnOver_2020Q1, stock.getInfoFloat ("QEPS", "2020Q1", "EPS"), earnRate)
    #  毛利的計算
    if stock.getInfoFloat ("QEPS", "2020Q1", "EPS") == None:
        continue
    pureEarn = value * stock.getInfoFloat ("QEPS", "2020Q1", "EPS") / 10
    ...
    info["TurnOver_2020Q2"] = "%.2f" % (TurnOver_2020Q2,)
    if TurnOver_2020Q2 == 0:
        continue
    #  毛利的計算
    #earnRate = stock.getInfoFloat ("QEPS", "2020Q2", "稅後淨利率")
    #if earnRate == None:
    #    continue
    ...
    if stock.getInfoFloat ("QEPS", "2020Q2", "EPS") == None:
        continue
    pureEarn = value * stock.getInfoFloat ("QEPS", "2020Q2", "EPS") / 10
...
file = open ("../info/eps_2020.txt", "w", encoding="utf-8")
